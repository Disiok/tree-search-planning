...
class MuZeroConfig:
    def __init__(self):
        ...
        # AlphaZero dynamics model
        self.dynamics_model = "perfect"  # "perfect" or "learned"
        # self.dynamics_model = "learned"  # "perfect" or "learned"
...
class Game(AbstractGame):
    ...
    def render(self):
        ...
        """
        self.env.render()
        inumpyut("Press enter to take a step ")
