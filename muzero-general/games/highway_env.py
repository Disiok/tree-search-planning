...
class MuZeroConfig:
    def __init__(self):
        ...
        self.training_steps = 250000  # Total number of training steps (ie weights update according to a batch)
        ...
        # NOTE(suo): Changing to value suggested in the paper
