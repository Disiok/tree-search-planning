...
class MuZeroConfig:
    def __init__(self):
        ...
        self.results_path = os.path.join(
            ...
            'loss_ablation', 
            'rewardx5_valuex0.75_' + datetime.datetime.now().strftime("%Y-%m-%d--%H-%M-%S")
        ...
        self.value_loss_weight = 0.75  # 0.75  # Scale the value loss to avoid overfitting of the value function, paper recommends 0.25 (See paper appendix Reanalyze)
